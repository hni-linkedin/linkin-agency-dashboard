    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {[1, 2, 3].map((i) => (
            ...
            >
              ...
              <SkeletonBlock height={12} width={i === 1 ? "92%" : i === 2 ? "80%" : "68%"} radius="var(--r-sm)" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 10 }}>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 12, justifyContent: "space-between" }}>
            ...
            <div style={{ width: 160 }}>
              {[0, 1, 2, 3, 4].map((i) => (
                ...
                >
                  ...
                  <SkeletonBlock height={10} width={i === 4 ? "70%" : "88%"} radius="var(--r-sm)" />
          ...
          <div style={{ marginTop: "auto", paddingTop: 8, borderTop: "1px dashed var(--border-subtle)" }}>
        ...
        >
          <div style={{ padding: "1rem 1.2rem", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 7, flex: 1 }}>
              {[0, 1, 2, 3].map((i) => (
                ...
                >
                  <SkeletonBlock height={10} width={i === 3 ? "52%" : "60%"} radius="var(--r-sm)" />
          ...
          <div style={{ background: "#0a0e14", minHeight: 260, display: "flex", alignItems: "center", justifyContent: "center" }}>
